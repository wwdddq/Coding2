...
Boid::Boid()
{
	separationWeight = 9.0f;
	cohesionWeight = 0.3f;
	alignmentWeight = 2.0f;
	
	separationThreshold = 30;
	neighbourhoodSize = 120;
	
	position = ofVec3f(ofRandom(100, 200), ofRandom(0, 200));
	velocity = ofVec3f(ofRandom(-2, 30), ofRandom(-30, 2));
}
